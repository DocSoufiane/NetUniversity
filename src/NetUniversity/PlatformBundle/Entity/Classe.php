...
class Classe
{
  ...
  /**
   * @ORM\ManyToMany(targetEntity="NetUniversity\PlatformBundle\Entity\Support", cascade={"persist"}, inversedBy="classePartage")
  ...
  private $support;
    ...
    {
        $this->sujet = new \Doctrine\Common\Collections\ArrayCollection();
    }
     ...
     * Add support.
     *
     * @param \NetUniversity\PlatformBundle\Entity\Support $support
     *
     * @return Classe
     */
    public function addSupport(\NetUniversity\PlatformBundle\Entity\Support $support)
    {
     ...
     * @return boolean TRUE if this collection contained the specified element, FALSE otherwise.
     */
    public function removeSupport(\NetUniversity\PlatformBundle\Entity\Support $support)
    {
