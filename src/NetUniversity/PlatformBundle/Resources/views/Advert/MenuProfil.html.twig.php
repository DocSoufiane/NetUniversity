          <button onclick="myFunction('Demo0')" class="w3-btn-block w3-theme-l1 w3-left-align"><i class="fa fa-circle-o-notch fa-fw w3-margin-right"></i> My Projects</button>
          <div id="Demo0" class="w3-accordion-content w3-container">
            <p>Some text..</p>
          </div>
